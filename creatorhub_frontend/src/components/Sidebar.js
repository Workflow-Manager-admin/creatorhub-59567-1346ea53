        ...
        {drawerOpen && (
          <aside
            ...
            style={{
              ...
              left: 0,
              width: "100vw",
              background: "rgba(60,68,112,0.96)", // Mobile drawer background
              borderRadius: "0 0 25px 25px",
              zIndex: 222,
              animation: "fade-in 0.31s",
              boxShadow: "0 12px 60px 0 #151b2fd9",
              paddingTop: "24px" // Add padding for logo
            }}
          >
            {/* Logo/logo-text for Mobile Drawer */}
            <div
              style={{
                ...
                fontSize: "2.2rem",
                color: "var(--kavia-orange)", // Assumes --kavia-orange is defined
                marginBottom: "32px",
                display: "flex",
                alignItems: "center",
                justifyContent: "center", // Center for mobile drawer
                userSelect: "none"
              }}
            >
              {/* Replace with your actual logo SVG/image if you have one, or keep just text */}
              CreatorHub
            </div>
                ...
                <li
                  ...
                  style={{
                    ...
                    background: activeTab === link.key
                      ? "var(--button-blaze-orange)" // Active tab background
                      : "none",
                ...
                >
                  ...
                  {activeTab === link.key && (
                    <span
                      aria-hidden="true"
                      style={{
                        background: "var(--accent-gradient)", // Small indicator gradient
                        borderRadius: "7px",
                        width: 8, height: 8,
                        marginLeft: "auto"
                      }}
  ...
  return (
    <aside
      ...
      style={{
        ...
        background: "var(--card-bg)", // Desktop sidebar background
        display: "flex", // Added for flex column layout with logo
        flexDirection: "column", // Added for flex column layout with logo
        alignItems: collapsed ? "center" : "flex-start", // Adjust alignment when collapsed
        paddingTop: "24px" // Add padding for logo
      }}
    >
      {/* Logo/logo-text for Desktop Sidebar */}
      <div
        style={{
          fontFamily: "'Montserrat', 'Arial', sans-serif",
          fontWeight: 900,
          letterSpacing: "0.02em",
          fontSize: "2.2rem",
          color: "var(--primary)", // Assumes --kavia-orange is defined
          marginBottom: "32px",
          display: "flex",
          alignItems: "center",
          justifyContent: collapsed ? "center" : "flex-start", // Center when collapsed
          userSelect: "none",
          padding: collapsed ? "0" : "0 22px 0 13px", // Adjust padding
          transition: "padding 0.25s" // Smooth transition for padding
        }}
      >
        {/* If you have a small icon for the logo when collapsed, put it here */}
        {collapsed ? (
          <span style={{ fontSize: "1.5rem" }}>💡</span> // Example: a small icon when collapsed
        ) : (
          "CreatorHub" // Full text when not collapsed
        )}
      </div>
        ...
        {links.map((link, idx) => (
          <li
            ...
            style={{
              ...
              width: collapsed ? 44 : "calc(100% - 26px)", // Dynamic width based on collapsed state and padding
              boxSizing: "border-box", // Ensure padding is included in width
              cursor: "pointer",
              overflow: "visible",
              transition:
                "background 0.22s, color .17s, font-weight .14s, box-shadow .19s, padding 0.18s, min-width 0.18s, width 0.18s" // Added width to transition
            }}
          >
            <span
              style={{
            ...
            {activeTab === link.key && (
              <span
                ...
                style={{
                  ...
                  borderRadius: 4,
                  background: "linear-gradient(92deg,#FF7E5F 26%,#FD3A69 100%)", // Side indicator gradient
